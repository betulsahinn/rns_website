...
const Header = () => {
    ...
    if (error) return <div>Error loading menu data</div>;
                        ...
                        <div className="row align-items-start">
                            ...
                            <div className="col-6">
                                <div className="header-top__support text-end">
                                    <span>Telefon ile ulaşın: <Link href="tel:0850 255 19 06">0850 255 19 06</Link></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
{/*                                        <Link className="d-none d-lg-inline-block last-child" href="/login">
                                            <UserIcon />
                                            <span>Giriş Yap</span>
                                        </Link>*/}
                                    </div>
...
{/*                                        <Link className="tp-btn-white tp-btn-hover alt-color-black d-none d-md-inline-block"
                                        ...
                                        <a className="header-bottom__bar d-lg-none tp-menu-bar"
