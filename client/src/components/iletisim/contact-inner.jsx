...
const inner_content = {
  title: "Online Sunum Talebi!",
  description: <>Rönesis PRO Yönetim Sistemleri</>,

  contact_data: [
    {
      id: 1,
      icon: icon_1,
      title: "iletisim@ronesis.com.tr",
      link: "mailto:iletisim@ronesis.com.tr",
    },
    {
      id: 2,
      icon: icon_2,
      title: "0850 255 19 06",
      link: "tel:+0-850-255-1906",
    },
    {
      id: 3,
      icon: icon_3,
      title: "RÖNESANS PLAZA",
      link: "https://maps.app.goo.gl/MvbNzwGQAML9uLkk8",
    },
  ],
};
