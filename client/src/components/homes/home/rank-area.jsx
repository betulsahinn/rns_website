...
import bg_right_img from "../../../../public/assets/img/rank/rank-bg-shape-orange.png" ;
...
const rank_data = [
    {
        ...
        // clg_3: "",
        domain: "Rönesis PRO",
        visitors: "İnovasyon ve Mühendislik A.Ş.",
...
const rank_content = {
    //sub_title: "Rönesans İnovasyon ve Mühendislik",
    title: <>Gelecek Ürünlerimiz..</>,
    btn_text: "Keşfet !",
...
const RankArea = () => {
    return (
        <>
            <div className="tp-rank__area pb-200 mt-130">
                    ...
                    <div className="row">
                        <div className="col-xl-5 col-lg-5 order-1 order-lg-1">
                            ...
                            <div className="tp-rank__btn wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                                <Link className="tp-btn tp-btn-hover alt-color-black" href="/iletisim">
                                    <span>{btn_text}</span>
                                    <b></b>
                                </Link>
                            </div>
                                ...
                                <div className="tp-rank__rank-card wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".7s">
                                    ...
                                    <Image src={item.img} alt="" />
                                            ...
                                            <div className="tp-rank__company-info">
                                                <Link href="/ronesis">{item.domain} </Link>
