...
import img from "../../../public/assets/img/service/telefon.png"

const service_content = {
    title: "MOBİL UYGULAMA",
    sub_title: <>Sendika Yapısına Uygun Mobil Uygulama</>,

    bg_img: "/assets/img/service/sv-bg.jpg",
    title_2: <>Mobil Uygulama ile Üyelerle İletişiminizi Güçlendirin !</>,
    des: <>Üyelerinizi ayrıcalıklı hissettirin.</>,
    btn_text: "Bizimle Çalışın",
                        ...
                        <div key={i} className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay={item.delay}>
                            <div className="tp-service__item mb-30">
                                ...
                                <div className="tp-service__content">
                                    <h3 className="tp-service__title-sm tp-yellow-color"><Link href="/ronesis">{item.title}</Link></h3>
                     ...
                     <div className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                        ...
                        style={{backgroundImage: `url(${bg_img})`}} >
                           <div className="tp-service__top-content">
                              ...
                              <p>{des}</p>
                              <Link className="tp-btn-orange tp-btn-hover alt-color-white" href="/iletisim">
                                 <span>{btn_text}</span>
                                 <b></b>
                              </Link>
                           </div>
