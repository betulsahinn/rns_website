...
import about_img_2 from "../../public/assets/img/about/homepage2.png"
import about_img_3 from "../../public/assets/img/about/homepage3.png"
import about_img_4 from "../../public/assets/img/about/homepage4.png"
import about_img_5 from "../../public/assets/img/about/relationship.png"
...
const about_content = {
    ...
    about_list: [
        <>Yer , zaman ve cihazdan bağımsız olarak dilediğiniz an yönetin.</>,
        <>Sistematik ara yüzü sayesinde eğitime gerek kalmaksızın kolayca kullanın.</>,
        <>Günler hatta haftalar alan işlemleri saniyeler içerisinde gerçekleştirin.</>,
    ],
    btn_text: "Hakkımızda",
                     ...
                     <div className="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".6s">
                        <div className="tp-about__right">
                           ...
                           <div className="tp-about__btn">
                              <Link className="tp-btn tp-btn-hover alt-color-black" href="/ozellikler">
                                 <span>{btn_text}</span>
                                 <b></b>
                              </Link>
                           </div>
