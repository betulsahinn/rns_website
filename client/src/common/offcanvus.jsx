...
{/*                    <Link href="#"><Image src={canvus_img_1}  alt="theme-pure" /></Link>
                    ...
                    <h4 className="offcanva-title">Konumumuz</h4>
                    <Link href="https://maps.app.goo.gl/zsMJq6vM5TVXqeT98" target="_blank">
                        Güzelhisar, RÖNESANS PLAZA, Albay Şefik Cd. <br />
                        NO:4 KAT:6 DAİRE:24, 09100 Efeler/Aydın
                    </Link>
                    </div>
                    ...
                    <div className="social-icon text-center">
                        ...
                        <Link href="https://www.facebook.com/Ronesiscom/"><i className="fab fa-facebook-square"></i></Link>
                    </div>
                    </div>
                </div>
            </div>
