                ...
                <div className="row">
                  <div className="col-xl-12">
                    ...
                    <div className="tp-error-text-box text-center">
                      <h4 className="error-title-sm">Hay Aksi !<br/>Sayfa Bulunamadı..</h4>
                      <p>Aradığınız kaynak kaldırılmış , adı değiştirilmiş ya da geçici olarak kullanım dışı olabilir.</p>
                      <Link
